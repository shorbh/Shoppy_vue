 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x0(t){return Im(void 0,t)}function Im(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!D0(n)||(t[n]=Im(t[n],e[n]));return t}function D0(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IC{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(TC(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function TC(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const _l="@firebase/app",tf="0.9.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ur(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Ot&&IA(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function IA({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l_{constructor(e,n,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:i,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return bS;case"linkViaPopup":case"linkViaRedirect":return TS;case"reauthViaPopup":case"reauthViaRedirect":return IS;default:qt(this.auth,"internal-error")}}resolve(e){En(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){En(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kO=new Map,OO={activated:!1,tokenObservers:[]};function on(t){return kO.get(t)||Object.assign({},OO)}const If={OFFSET_DURATION:5*60*1e3,RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MO="firebase-app-check-database",LO=1,bl="firebase-app-check-store";let Zr=null;function FO(){return Zr||(Zr=new Promise((t,e)=>{try{const n=indexedDB.open(MO,LO);n.onsuccess=s=>{t(s.target.result)},n.onerror=s=>{var i;e(Lo.create("storage-open",{originalErrorMessage:(i=s.target.error)===null||i===void 0?void 0:i.message}))},n.onupgradeneeded=s=>{const i=s.target.result;switch(s.oldVersion){case 0:i.createObjectStore(bl,{keyPath:"compositeKey"})}}}catch(n){e(Lo.create("storage-open",{originalErrorMessage:n==null?void 0:n.message}))}}),Zr)}function UO(t,e){return BO($O(t),e)}async function BO(t,e){const s=(await FO()).transaction(bl,"readwrite"),r=s.objectStore(bl).put({compositeKey:t,value:e});return new Promise((o,a)=>{r.onsuccess=c=>{o()},s.onerror=c=>{var l;a(Lo.create("storage-set",{originalErrorMessage:(l=c.target.error)===null||l===void 0?void 0:l.message}))}})}function $O(t){return`${t.options.appId}-${t.name}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Il=new pi("@firebase/app-check");function Tf(t,e){return Du()?UO(t,e).catch(n=>{Il.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bc={},Ic={};function Gu(t){const e=t.toString();return bc[e]||(bc[e]=new TP),bc[e]}function CP(t,e){const n=t.toString();return Ic[n]||(Ic[n]=e()),Ic[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kf=10*1e3,bN=30*1e3,IN=5*60*1e3;class TN{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new EN(e);const s=Kf+(bN-Kf)*Math.random();Ki(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;Rt(e,(i,r)=>{r>0&&Cn(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),Ki(this.reportStats_.bind(this),Math.floor(Math.random()*2*IN))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=Qt.OVERWRITE}operationForChild(e){return se(this.path)?new Ts(this.source,_e(),this.snap.getImmediateChild(e)):new Ts(this.source,Ie(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Qt.MERGE}operationForChild(e){if(se(this.path)){const n=this.children.subtree(new Te(e));return n.isEmpty()?null:n.value?new Ts(this.source,_e(),n.value):new pr(this.source,_e(),n)}else return N(re(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new pr(this.source,Ie(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f1=/[\[\].#$\/\u0000-\u001F\u007F]/,p1=/[\[\].#$\u0000-\u001F\u007F]/,Sc=10*1024*1024,by=function(t){return typeof t=="string"&&t.length!==0&&!f1.test(t)},g1=function(t){return typeof t=="string"&&t.length!==0&&!p1.test(t)},m1=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),g1(t)},Iy=function(t,e,n){const s=n instanceof Te?new YP(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+ts(s));if(typeof e=="function")throw new Error(t+"contains a function "+ts(s)+" with contents = "+e.toString());if(b_(e))throw new Error(t+"contains "+e.toString()+" "+ts(s));if(typeof e=="string"&&e.length>Sc/3&&Aa(e)>Sc)throw new Error(t+"contains a string greater than "+Sc+" utf8 bytes "+ts(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(Rt(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!by(o)))throw new Error(t+" contains an invalid key ("+o+") "+ts(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);JP(s,o),Iy(t,a,s),XP(s)}),i&&r)throw new Error(t+' contains ".value" child '+ts(s)+" in addition to actual children.")}},_1=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!by(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!m1(n))throw new Error(Q0(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F1="FIREBASE_DATABASE_EMULATOR_HOST",Ul={};let U1=!1;function B1(t,e,n,s,i){let r=s||t.options.databaseURL;r===void 0&&(t.options.projectId||bs("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),Ke("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=ap(r,i),a=o.repoInfo,c,l;typeof process<"u"&&process.env&&(l=process.env[F1]),l?(c=!0,r=`http://${l}?ns=${a.namespace}`,o=ap(r,i),a=o.repoInfo):c=!o.repoInfo.secure;const u=i&&c?new Sl(Sl.OWNER):new EP(t.name,t.options,e);_1("Invalid Firebase Database URL",o),se(o.path)||bs("Database URL must point to the root of a Firebase Database (not including a child path).");const h=j1(a,t,u,new wP(t.name,n));return new H1(h,t)}function $1(t,e){const n=Ul[e];(!n||n[t.key]!==t)&&bs(`Database ${e}(${t.repoInfo_}) has already been deleted.`),O1(t),delete n[t.key]}function j1(t,e,n,s){let i=Ul[e.name];i||(i={},Ul[e.name]=i);let r=i[t.toURLString()];return r&&bs("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new T1(t,U1,n,s),i[t.toURLString()]=r,r}class H1{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(C1(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Ei(this._repo,_e())),this._rootInternal}_delete(){return this._rootInternal!==null&&($1(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&bs("Cannot call "+e+" on a deleted database.")}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _D(t){return t!==void 0}function Tp(t,e,n,s){if(s<e)throw Ip(`Invalid value for '${t}'. Expected ${e} or greater.`);if(s>n)throw Ip(`Invalid value for '${t}'. Expected ${n} or less.`)}function yD(t){const e=encodeURIComponent;let n="?";for(const s in t)if(t.hasOwnProperty(s)){const i=e(s)+"="+e(t[s]);n=n+i+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yv=new Map;function Jv(t,e){const n=ec(t);Xv(n,e),EM(n,e)}function Xv(t,e){const n=Yv.get(t);if(n)for(const s of n)s(e)}function EM(t,e){const n=bM();n&&n.postMessage({key:t,fid:e}),IM()}let ls=null;function bM(){return!ls&&"BroadcastChannel"in self&&(ls=new BroadcastChannel("[Firebase] FID Change"),ls.onmessage=t=>{Xv(t.data.key,t.data.fid)}),ls}function IM(){Yv.size===0&&ls&&(ls.close(),ls=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt=new pi("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gL(){if(Du())try{await Rm()}catch(t){return bt.warn(St.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return bt.warn(St.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function mL(t,e,n,s,i,r,o){var a;const c=uL(t);c.then(p=>{n[p.measurementId]=p.appId,t.options.measurementId&&p.measurementId!==t.options.measurementId&&bt.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${p.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(p=>bt.error(p)),e.push(c);const l=gL().then(p=>{if(p)return s.getId()}),[u,h]=await Promise.all([c,l]);sL(r)||XM(r,u.measurementId),i("js",new Date);const d=(a=o==null?void 0:o.config)!==null&&a!==void 0?a:{};return d[GM]="firebase",d.update=!0,h!=null&&(d[KM]=h),i("config",u.measurementId,d),u.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _L{constructor(e){this.app=e}_delete(){return delete Xi[this.app.options.appId],Promise.resolve()}}let Xi={},xp=[];const Dp={};let Wc="dataLayer",yL="gtag",Mp,ow,Lp=!1;function vL(){const t=[];if(Cm()&&t.push("This is a browser extension environment."),H0()||t.push("Cookies are not available."),t.length>0){const e=t.map((s,i)=>`(${i+1}) ${s}`).join(" "),n=St.create("invalid-analytics-context",{errorInfo:e});bt.warn(n.message)}}function wL(t,e,n){vL();const s=t.options.appId;if(!s)throw St.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)bt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw St.create("no-api-key");if(Xi[s]!=null)throw St.create("already-exists",{id:s});if(!Lp){QM(Wc);const{wrappedGtag:r,gtagCore:o}=nL(Xi,xp,Dp,Wc,yL);ow=r,Mp=o,Lp=!0}return Xi[s]=mL(t,xp,Dp,e,Mp,Wc,n),new _L(t)}function EL(t=Lu()){t=Pt(t);const e=gi(t,sa);return e.isInitialized()?e.getImmediate():bL(t)}function bL(t,e={}){const n=gi(t,sa);if(n.isInitialized()){const i=n.getImmediate();if(cr(e,n.getOptions()))return i;throw St.create("already-initialized")}return n.initialize({options:e})}function IL(t,e,n,s){t=Pt(t),pL(ow,Xi[t.app.options.appId],e,n,s).catch(i=>bt.error(i))}const Fp="@firebase/analytics",Up="0.9.3";function TL(){dt(new rt(sa,(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return wL(s,i,n)},"PUBLIC")),dt(new rt("analytics-internal",t,"PRIVATE")),Ve(Fp,Up),Ve(Fp,Up,"esm2017");function t(e){try{const n=e.getProvider(sa).getImmediate();return{logEvent:(s,i,r)=>IL(n,s,i,r)}}catch(n){throw St.create("interop-component-reg-failed",{reason:n})}}}TL();const CL={apiKey:"AIzaSyBlNU2F5YApICKQ3BHRwZB5zXjMleGkW-E",authDomain:"shop-42abc.firebaseapp.com",projectId:"shop-42abc",storageBucket:"shop-42abc.appspot.com",messagingSenderId:"720238628959",appId:"1:720238628959:web:23ff966700016c8d08cbea",measurementId:"G-LMT83VTWMN"},aw=Nm(CL);EL(aw);const nc=Db(uT);nc.use(Fb());nc.use(Mv);nc.use(DD,{firebaseApp:aw,modules:[ND()]});nc.mount("#app");
